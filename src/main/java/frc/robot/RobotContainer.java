...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(_driver, JoystickConstants.A).whileHeld(new ShooterV2Go(_shooter, _hopper, COLOR.Green)); 
    new JoystickButton(_driver, JoystickConstants.Y).whileHeld(new ShooterV2Go(_shooter, _hopper, COLOR.Yellow));
    new JoystickButton(_driver, JoystickConstants.X).whileHeld(new ShooterV2Go(_shooter, _hopper, COLOR.Blue));
    // new JoystickButton(_driver, JoystickConstants.B).whileHeld(new ShooterV2Go(_shooter, _hopper, COLOR.Red));

    new JoystickButton(_driver, JoystickConstants.B).whenPressed(new AutonIntake(_intake, _drive_Train, "Test-Curve"));
  }
